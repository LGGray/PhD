...
for(cell in levels(pbmc)){
    ...
    bulk.chrX <- cbind(class=meta$condition, individual=meta$individual, cellCount=meta$cellCount, age=meta$development_stage,
    ancestry=meta$ethnicity, bulk.chrX)
    bulk.autosome <- cbind(class=meta$condition, individual=meta$individual, cellCount=meta$cellCount, age=meta$development_stage,
    ancestry=meta$ethnicity, bulk.autosome)
    cell <- gsub('/| |-', '.', cell)
...
for(cell in levels(pbmc)){
    ...
    # Add metadata to each pseudobulk matrix
    bulk.HVG <- cbind(class=meta$condition, individual=meta$individual, cellCount=meta$cellCount, age=meta$development_stage,
    ancestry=meta$ethnicity, bulk.HVG)
    bulk.HVG.autosome <- cbind(class=meta$condition, individual=meta$individual, cellCount=meta$cellCount, age=meta$development_stage,
    ancestry=meta$ethnicity, bulk.HVG.autosome)
    cell <- gsub('/| |-', '.', cell)
...
for(cell in levels(pbmc)){
    ...
    # Add metadata to each pseudobulk matrix
    bulk.SLE <- cbind(class=meta$condition, individual=meta$individual, cellCount=meta$cellCount, age=meta$development_stage,
    ancestry=meta$ethnicity, bulk.SLE)
    cell <- gsub('/| |-', '.', cell)
