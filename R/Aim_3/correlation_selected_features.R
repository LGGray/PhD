...
lapply(split(assortativity_metrics, assortativity_metrics$gene.set), function(x) cor(x$assortativity, x$F1, method='spearman'))
...
pdf('figures/assortativity_nFeatures.pdf', width=10, height=5)
ggplot(assortativity_metrics, aes(x=F1, y=assortativity, colour=gene.set)) +
