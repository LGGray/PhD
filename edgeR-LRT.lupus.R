...
pbmc <- readRDS('seurat.object/pbmc.european.RDS')

pbmc@meta.data$disease <- gsub('systemic lupus erythematosus', 'SLE', 
                               pbmc@meta.data$disease)pbmc
...
pbmc.cell$RA <- factor(pbmc.cell$RA, levels = c('Y', 'N'))
